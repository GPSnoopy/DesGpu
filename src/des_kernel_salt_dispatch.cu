...
void des_25_encrypt(size_t num_blocks, size_t threads_per_block, const uint32_t salt, vtype* const unchecked_hashes, const bs_vector* const bitsplitted_keys)
{
	switch (salt)
	{
	case 0:
